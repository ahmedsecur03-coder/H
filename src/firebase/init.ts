...
import { getFirestore, Firestore, initializeFirestore, memoryLocalCache, persistentLocalCache } from 'firebase/firestore';
...
export function initializeFirebase(): FirebaseServices {
  ...
  const firestore = initializeFirestore(firebaseApp, {
    // Using persistent cache for a better offline experience and faster initial loads.
