...
export const TikTokPartnerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 160 40" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <text x="70" y="25" fontFamily="Arial, sans-serif" fontSize="8" fill="currentColor" fontWeight="bold">MARKETING PARTNER</text>
    </svg>
);
...
export const SnapchatPartnerIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 100 35" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g transform="scale(0.35) translate(-1, -8)">
        ...
        <text x="50" y="19" fontFamily="Arial, sans-serif" fontSize="7" fill="currentColor" textAnchor="middle" fontWeight="bold">AGENCY</text>
        <text x="50" y="29" fontFamily="Arial, sans-serif" fontSize="7" fill="currentColor" textAnchor="middle" fontWeight="bold">PARTNER</text>
    </svg>
);
